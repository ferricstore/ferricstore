defmodule FerricstoreServer.Health.DashboardTest.Sections.FlowDetailActions do
  @moduledoc false
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      describe "collect_flow_detail_page/1 actions and values" do
        ...
        test "Flow overview detail links preserve partition key" do
          ...
          assert String.contains?(
                   html,
                   ~s(href="/dashboard/flow/#{encoded_id}?#{encoded_partition}")
                 )
        end
      end
    end
