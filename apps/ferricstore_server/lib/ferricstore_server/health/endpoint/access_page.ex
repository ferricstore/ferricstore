defmodule FerricstoreServer.Health.Endpoint.AccessPage do
  ...
  def render(
    ...
    context_status = Map.get(options, :context_status, "Protected access")

    context_class =
      if Map.get(options, :context_warning, false), do: " context-status-warning", else: ""
      ...
      <main class="auth-shell">
        ...
        <div class="auth-surface">
          ...
          <aside class="auth-context" aria-label="Access context">
            <div class="context-status#{context_class}"><span aria-hidden="true"></span>#{escape(context_status)}</div>
