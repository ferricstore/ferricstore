defmodule FerricstoreServer.Acl.CommandCategories do
  ...
  @flow_read ~w(
    FLOW.GET FLOW.POLICY.GET FLOW.LIST FLOW.BY_PARENT FLOW.BY_ROOT FLOW.BY_CORRELATION
    FLOW.INFO FLOW.STUCK FLOW.STATS FLOW.ATTRIBUTES FLOW.ATTRIBUTE_VALUES FLOW.HISTORY FLOW.TERMINALS FLOW.FAILURES FLOW.SCHEDULE.GET FLOW.SCHEDULE.LIST
  )
  @flow_write ~w(
    ...
    FLOW.CANCEL_MANY FLOW.REWIND FLOW.RETENTION_CLEANUP FLOW.SCHEDULE.CREATE FLOW.SCHEDULE.DELETE FLOW.SCHEDULE.FIRE FLOW.SCHEDULE.PAUSE FLOW.SCHEDULE.RESUME FLOW.SCHEDULE.FIRE_DUE
  )
  ...
  @admin_commands ~w(
    ...
    FERRICSTORE.CONFIG FERRICSTORE.HOTNESS FERRICSTORE.METRICS FERRICSTORE.BLOBGC FERRICSTORE.DOCTOR FLOW.RETENTION_CLEANUP
  ...
  @dangerous_commands ~w(
    ...
    CLUSTER.DEMOTE FERRICSTORE.CONFIG FERRICSTORE.BLOBGC FERRICSTORE.DOCTOR FLOW.RETENTION_CLEANUP
  )
