defmodule Ferricstore.Flow do
  ...
  defp validate_children(children), do: Ferricstore.Flow.ChildPolicy.validate_children(children)
  ...
  defp create_many_item_opts(item), do: Ferricstore.Flow.ManyItemOpts.create(item)
  ...
  defp complete_many_item_opts(item), do: Ferricstore.Flow.ManyItemOpts.complete(item)

  defp retry_many_item_opts(item), do: Ferricstore.Flow.ManyItemOpts.retry(item)

  defp fail_many_item_opts(item), do: Ferricstore.Flow.ManyItemOpts.fail(item)

  defp cancel_many_item_opts(item), do: Ferricstore.Flow.ManyItemOpts.cancel(item)
  ...
  defp transition_many_item_opts(item), do: Ferricstore.Flow.ManyItemOpts.transition(item)

  defp merge_many_item_opts(base_opts, item_opts, partition_key),
