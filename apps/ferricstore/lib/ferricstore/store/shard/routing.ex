    ...
    quote do
      ...
      defp direct_sm_state(state) do
        %{
          ...
          namespace_usage_index_name: state.namespace_usage_index,
          namespace_usage_expiry_name: state.namespace_usage_expiry,
          blob_side_channel_threshold_bytes: state.blob_side_channel_threshold_bytes,
