defmodule Ferricstore.Raft.StateMachine do
  ...
  @sm_pending_write_keys [
    ...
    :sm_pending_flow_native_batches,
    :sm_pending_flow_native_flush?,
    :sm_pending_zset_index_ops,
    :sm_apply_promoted_latches,
    ...
    :sm_pending_stream_cache_updates,
    :sm_pending_stream_index_dirty_keys,
    :sm_pending_stream_group_updates,
    :sm_pending_prob_creates,
    :sm_pending_prob_paths,
    :sm_pending_prob_deletes,
    :sm_pending_storage_published?,
  ...
  @sm_pending_write_initial_values [
    ...
    sm_pending_flow_history_projections: [],
    sm_pending_flow_native_ops: [],
    sm_pending_flow_native_batches: nil,
    ...
    sm_pending_stream_cache_updates: [],
    sm_pending_stream_index_dirty_keys: MapSet.new(),
    sm_pending_stream_group_updates: [],
    sm_pending_prob_creates: %{},
    sm_pending_prob_paths: %{by_final: %{}, by_create: %{}},
    sm_pending_prob_deletes: MapSet.new(),
    sm_pending_storage_published?: false,
