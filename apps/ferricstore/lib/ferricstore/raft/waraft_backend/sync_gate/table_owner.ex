defmodule Ferricstore.Raft.WARaftBackend.SyncGate.TableOwner do
  @moduledoc false
  ...
  @table :ferricstore_waraft_sync_admissions
  @table_heir Ferricstore.Raft.WARaftBackend.SyncGate.TableHeir
  @heir_retry_ms 10
