defmodule Ferricstore.MemoryGuard do
  ...
  *Writes rejected only when eviction_policy is `:noeviction`.
  ...
  @doc false
  def detect_memory_limit, do: SystemMemory.detect_memory_limit()

  @doc false
  def parse_sysctl_memsize(output), do: SystemMemory.parse_sysctl_memsize(output)
  ...
  @doc false
  def process_rss_bytes, do: SystemMemory.process_rss_bytes()

  @doc false
  def parse_ps_rss_kb(output), do: SystemMemory.parse_ps_rss_kb(output)
