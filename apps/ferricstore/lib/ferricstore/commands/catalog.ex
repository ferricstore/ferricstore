defmodule Ferricstore.Commands.Catalog do
  ...
  @commands [
    ...
    # -- Flow --------------------------------------------------------------
    %{name: "flow.create", arity: -4, flags: ["write", "denyoom"], first_key: 1, last_key: 1, step: 1,
      summary: "Creates a workflow record."},
    %{name: "flow.get", arity: -2, flags: ["readonly", "fast"], first_key: 1, last_key: 1, step: 1,
      summary: "Returns a workflow record."},
    %{name: "flow.claim_due", arity: -4, flags: ["write"], first_key: 0, last_key: 0, step: 0,
      summary: "Claims due workflow records for a worker."},
    %{name: "flow.complete", arity: -5, flags: ["write"], first_key: 1, last_key: 1, step: 1,
      summary: "Completes a leased workflow record."},
    %{name: "flow.transition", arity: -6, flags: ["write"], first_key: 1, last_key: 1, step: 1,
      summary: "Moves a workflow record between states."},
    %{name: "flow.retry", arity: -5, flags: ["write"], first_key: 1, last_key: 1, step: 1,
      summary: "Retries a leased workflow record."},
    %{name: "flow.fail", arity: -5, flags: ["write"], first_key: 1, last_key: 1, step: 1,
      summary: "Fails a leased workflow record."},
    %{name: "flow.cancel", arity: -4, flags: ["write"], first_key: 1, last_key: 1, step: 1,
      summary: "Cancels a workflow record."},
    %{name: "flow.list", arity: -2, flags: ["readonly"], first_key: 0, last_key: 0, step: 0,
      summary: "Lists workflow records by type and optional state."},
    %{name: "flow.info", arity: -2, flags: ["readonly", "fast"], first_key: 0, last_key: 0, step: 0,
      summary: "Returns workflow counters for a type."},
    %{name: "flow.stuck", arity: -2, flags: ["readonly"], first_key: 0, last_key: 0, step: 0,
      summary: "Lists stale running workflow records."},
    %{name: "flow.history", arity: -2, flags: ["readonly"], first_key: 1, last_key: 1, step: 1,
