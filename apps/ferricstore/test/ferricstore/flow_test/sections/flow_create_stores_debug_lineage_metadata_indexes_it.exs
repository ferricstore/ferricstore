defmodule Ferricstore.FlowTest.Sections.FlowCreateStoresDebugLineageMetadataIndexesIt do
  @moduledoc false
    ...
    quote do
      ...
      test "flow_claim_due partition_keys tries later shards when an earlier stale candidate claims nothing" do
        ...
        {flow_index, flow_lookup} =
          Ferricstore.Flow.OrderedIndex.table_names(ctx.name, stale_shard)
