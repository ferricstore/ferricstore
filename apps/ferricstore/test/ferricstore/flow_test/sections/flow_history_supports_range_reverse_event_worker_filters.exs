  ...
  defmacro __using__(_opts) do
    quote do
      ...
      test "flow_history filtered cold query keeps old head window before filtering" do
        previous_history_scan =
          Application.get_env(:ferricstore, :flow_lmdb_history_query_scan_limit)
      ...
      test "flow_terminals and flow_failures list terminal records by state and time range" do
        ...
        completed =
          create_claimed_flow(uid("flow-failures-c"), partition, type, "worker-failures")

        cancelled =
          create_claimed_flow(uid("flow-failures-d"), partition, type, "worker-failures")
