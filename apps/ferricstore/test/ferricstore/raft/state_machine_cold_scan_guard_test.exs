defmodule Ferricstore.Raft.StateMachineColdScanGuardTest do
  ...
  test "cross-shard prefix scans batch cold Bitcask reads" do
    ...
    [_, section] = String.split(source, "defp cross_shard_read_cold_batch(entries) do", parts: 2)

    section =
      section |> String.split("defp normalize_state_machine_batch_values", parts: 2) |> hd()
