defmodule Ferricstore.Flow.LMDBTest.Sections.MirrorWriterProjectsTerminalHistoryHotFlowIndexDuringFlush do
  @moduledoc false
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      test "mirror writer preserves projected history file locators" do
        ...
        instance_name =
          :"flow_lmdb_history_project_location_#{System.unique_integer([:positive])}"
      ...
      test "mirror writer emits backlog and flush telemetry" do
        ...
        assert_receive {:flow_lmdb_writer_telemetry,
                        [:ferricstore, :flow, :lmdb_writer, :backlog], backlog,
