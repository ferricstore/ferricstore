defmodule Ferricstore.Flow.LMDBTest.Sections.LineageIncludeColdReverseReadsNewestLmdbPrefixRows do
  @moduledoc false
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      test "partitioned cold terminal queries read the same LMDB shard that received projection" do
        ...
        ctx =
          Ferricstore.Test.IsolatedInstance.checkout(shard_count: 4, hot_cache_max_value_size: 1)
