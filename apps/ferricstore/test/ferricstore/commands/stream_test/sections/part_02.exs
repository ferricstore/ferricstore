defmodule Ferricstore.Commands.StreamTest.Sections.Part02 do
  @moduledoc false
  ...
  describe "XDEL" do
    test "stream deletes use batch get/delete on the hot path" do
      source =
        File.read!(Path.expand("../../../lib/ferricstore/commands/stream/mutations.ex", __DIR__))
      ...
      entries_source =
        File.read!(Path.expand("../../../lib/ferricstore/commands/stream/entries.ex", __DIR__))
