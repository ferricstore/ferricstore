      ...
      describe "GETBIT" do
        ...
        test "beyond known cold value size returns 0 without loading value" do
          store = %{
            ...
            get: fn _key ->
              flunk("GETBIT should not load a cold value for out-of-range offset")
            end
          }
      ...
      describe "BITCOUNT" do
        ...
        test "out-of-range cold value indices return 0 without loading value" do
          store = %{
            ...
            value_size: fn "cold" -> 1 end,
            get: fn _key ->
              flunk("BITCOUNT should not load a cold value for out-of-range range")
            end
          }
        ...
        test "large cold bit range counts in bounded chunks" do
          ...
          assert 4 ==
                   Bitmap.handle(
                     "BITCOUNT",
                     ["cold", "0", Integer.to_string(last_bit), "BIT"],
                     store
                   )
