(function () {
  ...
  },
  {
    ...
    "code": "delta.book_seat('DL402', request_id=f'{job.id}:flight:v1')",
    "charge": "+$850.00",
    "flight": "+$350.00",
    "hotel": "$0.00",
    "refund": "$0.00",
  ...
  },
  {
    ...
    "code": "marriott.book_suite(request_id=f'{job.id}:hotel:v1')",
    "charge": "+$850.00",
    "flight": "+$350.00",
    "hotel": "+$350.00",
    "refund": "$0.00",
  ...
  },
  {
    ...
    "code": "return complete(result={'status': 'BOOKING_COMPLETE'})",
    "charge": "+$850.00",
    "flight": "+$350.00",
    "hotel": "+$350.00",
    "refund": "$0.00",
  ...
  },
  {
    ...
    "code": "delta.cancel_seat(seat.id, request_id=f'{job.id}:cancel:v1')",
    "charge": "+$850.00",
