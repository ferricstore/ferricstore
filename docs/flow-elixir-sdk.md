...
The Elixir SDK adds a workflow-shaped API on top of those commands. It is for
developer ergonomics only. It does not add a replay engine, does not use RESP,
and does not change Flow durability or atomicity.
